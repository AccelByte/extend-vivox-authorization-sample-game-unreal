 ...
 * \note To use this request, a session must have already been created with media disconnected.
...
typedef struct vx_req_session_archive_query {
     ...
     * Responses provide a next_cursor value pointing to the next page of results when the result size is greater than the page size.
     * Set the cursor value with the next_cursor from previous responses when applicable.
     */
    char *cursor;
    ...
    /**
     * \deprecated This is deprecated and should not be used.
     * The namespace of the custom application stanza.
     * @deprecated
     */
    VX_DEPRECATED(5.21)
    char *application_stanza_namespace;
    ...
    /**
     * \deprecated This is deprecated and should not be used.
     * The body of the custom application stanza.
     * @deprecated
     */
    VX_DEPRECATED(5.21)
    char *application_stanza_body;
...
typedef struct vx_req_session_chat_history_query {
    ...
    /**
     * \deprecated This is deprecated and should not be used.
     * Currently not implemented in the backend and attempting to use will result in an error.
     * The fully specified URI of the participant.
     * Only messages to or from the specified participant are returned.
     * This is optional.
     * The default setting is NULL.
...
/**
 * Returns a list of conversations a user is participating in, in reverse order. Only returns conversations from a user's DMs
 * and also from channels where a user sent a message.
...
typedef struct vx_req_account_get_conversations {
    ...
    /**
     * The time of your first request, this ensures that you ignore newer messages coming into conversations
     * and therefor preserve the ordering between requests
     *
...
/**
 * Sets the message as read in a given conversation, this information will be used to calculate the
 * amount of unread messages in a conversation among other things.
